        ...
        <div className="flex h-screen">
            <div className="bg-white w-1/3 flex flex-col">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    ...
                    <button 
                    onClick={logout}
                    className="text-sm bg-blue-100 px-2 py-1 text-gray-700 border rounded-md">logout</button>
                </div>
            </div>
            <div className="flex flex-col bg-blue-100 w-2/3 p-2">
                ...
                {!!selectedUserId && (
                    <form className="flex gap-2" onSubmit={sendMessage}>
                        ...
                        <label type="button" className="bg-blue-300 p-2 text-gray-700 cursor-pointer rounded-sm border border-blue-500">
